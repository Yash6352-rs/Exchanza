  ...
  useEffect(() => {
    ...
    const init = async () => {
      try {
        ...
        // // FIX LOADING HERE (MOST RELIABLE)
        //     if (initialLoad) {
        //       setLoading(false);
        //       setInitialLoad(false);
        //     }

        unsubPosts = subscribeToUserPosts(currentUser.uid, (posts) => {
        ...
        unsubTrades = subscribeToUserTrades(currentUser.uid, (trades) => {
  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-center mb-4">
        ...
        <Pressable
          onPress={() => router.push("/features/settings/screens/SettingsScreen")}
        >
          <Ionicons name="menu" size={24} color={theme?.text || lightColors.text} />
        </Pressable>
      </View>
      ...
      >
        ...
        {isBlocked && (
          <BlockedNotice 
            ...
            message="Your account has been blocked by the admin. Some features like posting, trading, chatting, and review are currently disabled."
          />
        )}
        ...
        <View className="mt-4 w-full">
          <AppButton
            ...
            variant="outline"
            onPress={() =>
              router.push("/features/profile/screens/edit-profile")
            }
          />
        </View>
